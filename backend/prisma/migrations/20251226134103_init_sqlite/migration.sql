...
CREATE TABLE "room_participants" (
    ...
    CONSTRAINT "room_participants_room_id_fkey" FOREIGN KEY ("room_id") REFERENCES "chat_rooms" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "messages" (
    ...
    CONSTRAINT "messages_reply_to_message_id_fkey" FOREIGN KEY ("reply_to_message_id") REFERENCES "messages" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "message_translations" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "message_translations_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "messages" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "message_translations_target_language_idx" ON "message_translations"("target_language");
